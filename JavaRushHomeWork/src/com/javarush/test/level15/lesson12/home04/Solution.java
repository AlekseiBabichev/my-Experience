...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() {
        ...
        if (Planet.EARTH.equals(param)) thePlanet = Earth.getInstance(); else
        if (Planet.MOON.equals(param)) thePlanet = Moon.getInstance(); else
        if (Planet.SUN.equals(param)) thePlanet = Sun.getInstance(); else
        thePlanet = null;
